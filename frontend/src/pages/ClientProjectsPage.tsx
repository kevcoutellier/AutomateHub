...
export const ClientProjectsPage: React.FC = () => {
  ...
  const fetchProjects = async () => {
    try {
      setLoading(true);
      const projectsData = await projectApi.getClientProjects();
  ...
  const projectStats = {
    ...
    totalInvestment: projects.reduce((sum, p) => sum + p.budget.allocated, 0),
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Track your automation projects and their progress</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  ${projectStats.totalInvestment.toLocaleString()}
                </p>
              </div>
                      ...
                      <div 
                        className={`h-1 rounded-full transition-all duration-300 ${
                          (project.budget.spent / project.budget.allocated) > 0.8 
                            ? 'bg-red-500' 
                            : (project.budget.spent / project.budget.allocated) > 0.6 
                            ? 'bg-yellow-500' 
                            : 'bg-green-500'
                        }`}
          ...
          <Card className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              {searchTerm || filter !== 'all' 
                ...
                : 'Start your automation journey by creating your first project'
              }
            </p>
            {!searchTerm && filter === 'all' && (
              <Button 
